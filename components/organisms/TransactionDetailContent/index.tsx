...
import Row from "./Row";
import { TransactionDetailTypes } from "@/services/data-types";
          ...
          <div className="main-content main-content-card overflow-auto">
            <section className="checkout mx-auto">
                ...
                <div className="game-checkout d-flex flex-row align-items-center">
                  <div className="pe-4">
                    <div className="cropped">
                      <img
                        src={`${ROOT_IMG}/${data?.historyVoucherTopup?.thumbnail}`}
                        width="200"
                        height="130"
                        className="img-fluid"
                        alt=""
              ...
              <div className="purchase pt-30">
                ...
                <Row
                  label="Item"
                  value={data?.historyVoucherTopup?.coinQuantity}
                />
